...
private class RandomRDDPartition[T](override val index: Int,
    val size: Int,
...
class RandomRDD[T: ClassTag](sc: SparkContext,
    size: Long,
    numPartitions: Int,
...
class RandomVectorRDD(sc: SparkContext,
    size: Long,
    vectorSize: Int,
    numPartitions: Int,
